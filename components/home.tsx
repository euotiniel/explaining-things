    ...
    <div className="bg-[#F3F3F3] min-h-screen border border-dashed border-[#333333]/10 my-16">
          ...
          {components.map((post) => (
            ...
            >
              ...
              <div className="flex flex-col items-start justify-strat text-left">
                <h3 className="text-xl leading-relaxed mt-4">{post.title}</h3>
      ...
      <div className="flex flex-col items-center text-center mt-20 md:mt-28 mb-20 md:mb-24 gap-6  px-5 md:px-20">
        ...
        >
          ...
          <button
            type="submit"
            className="border-2 border-black/80 bg-black text-white py-2 text-xs font-semibold uppercase tracking-widest cursor-pointer hover:bg-black/90 transition-all active:translate-x-[2px] active:translate-y-[2px] active:shadow-none shadow-[3px_3px_0px_0px_rgba(0,0,0,0.4)]"
          >
            Inscrever
          </button>
        </form>
